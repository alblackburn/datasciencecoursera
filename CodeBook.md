# Variable names and definition/purpose
...
* frequencyBodyAccelerometerJerkMeanZ - Mean of frequency body acceleration jerk over the Z axis
...
* frequencyBodyGyroscopeMeanX - rad/sec, normalized and bounded within [-1,1]
